...
class plgEditorJodit extends JPlugin {
	...
	public function onGetContent($editor) {
		return 'Jodit.editors["jodit'.$editor.'"].val();';
	}
	...
	public function onSetContent($editor, $html) {
		return 'Jodit.editors["jodit'.$editor.'"].val(' . $html . ');';
	}
	...
	public function onSave($editor) {
		return "document.getElementById('{$editor}').value =  Jodit.editors['jodit".$editor."'].val();";
	}
	...
	public function onGetInsertMethod($name) {
        ...
        JFactory::getDocument()->addScriptDeclaration(";function jInsertEditorText(text, editor) {
            Jodit.editors['jodit' + editor].selection.insertHTML(text)
        }");
